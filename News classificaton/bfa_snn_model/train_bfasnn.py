...
dataX = "../../data/ag-news/train_x.npy"
dataY = "../../data/ag-news/train_y.npy"
devX = "../../data/ag-news/val_x.npy"
devY = "../../data/ag-news/val_y.npy"
...
n_iter = 3 ## number discrete time steps to simulate
mb_size = 50
...
tr_acc = 0.1
nll, acc = eval_model(model, Xdev, Ydev, mb_size=mb_size)
bestDevAcc = acc
