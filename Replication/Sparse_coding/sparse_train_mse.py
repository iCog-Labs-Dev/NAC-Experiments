...
from ngclearn.utils import metric_utils
...
n_iter = 100 # 10 ## total number passes through dataset
n_samples = -1
...
for i in range(n_iter):
    ...
    for j in range(n_batches):
        ...
        error = metric_utils.measure_MSE(Xb,xs_mu)
        
        MeanSquareErrors.append(error)
        print(f"++++++++++++++++++++++++ MSE=>    {error}\n")
    ...
    MSE = jnp.array(MeanSquareErrors)
